...
$config['licenseName'] = $_ENV['CKFINDER_LICENSENAME'];
$config['licenseKey']  = $_ENV['CKFINDER_LICENSEKEY'];
...
$config['backends'][] = array(
    ...
    'visibility'   => $_ENV['AWS_VISIBILITY'],
    'baseUrl'      => $_ENV['AWS_BASEURL'],
    'root'         => $_ENV['AWS_ROOT']
);
...
$config['defaultResourceTypes'] = 'Tower Energy Group,The Thermal Club,Tower Market';
...
$config['resourceTypes'][] = array(
    'name'              => 'Tower Market',
    'directory'         => 'tower-market-hr-forms',
    'maxSize'           => 0,
    'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
    'deniedExtensions'  => '',
    'backend'           => 'awss3'
